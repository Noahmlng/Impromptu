...
from models.topic_modeling import LDATopicModel, TopicResult
from models.vector_matching import FaissVectorMatcher, MatchResult
from models.matching_result import SimpleMatchingResult, create_match_dimension, generate_score_description, calculate_complementary_score
...
class EnhancedCompatibilityAnalyzer:
    ...
    def __init__(self, config: Optional[ConfigManager] = None):
        ...
        self.vector_matcher = FaissVectorMatcher(self.config_manager.vector_config)
    ...
    def _generate_overall_recommendation(self, vector_result: MatchResult) -> str:
        """生成综合建议"""
        if vector_result.similarity_score > 0.8:
            return "强烈推荐：两人在多个维度高度匹配，建议积极联系"
        elif vector_result.similarity_score > 0.6:
            return "推荐：两人具有良好的匹配度，可以尝试深入了解"
        elif vector_result.similarity_score > 0.4:
